...
const BookForm = () => {
  return (
    <>
      ...
      <div class="container mx-auto pt-[120px] pb-[100px] ">
      <div
        ...
        <div className=" lg:px-0 shadow-[0px_0px_20px_1px_#718096] lg:rounded-l-lg grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 lg:rounded-r-lg ">
