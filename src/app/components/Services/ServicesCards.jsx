          ...
          <div className="flex flex-wrap -mx-4 ">
            <div className="w-full px-4">
              <div className="mx-auto mb-[60px] max-w-[510px] text-center lg:mb-20">
                ...
                <img className="h-5 inline" src={blueLogo} alt="Blue Logo" /> offers top-quality cleaning services for offices, apartment buildings, and carpets using green-friendly solutions and best practices. Our trained staff help building managers stay focused on their core responsibilities by maintaining interiors. We understand the importance of fresh carpets and can schedule quarterly cleanings. <br />
                <br />Contact us to discuss cleaning services for your office, strata, carpets, construction sites, and more. Our goal is to consistently bring results so you can focus on your business, not cleaning.
                </p>
              </div>
            </div>
          </div>
    ...
    const ServiceCard = ({ image, date, CardTitle, CardDescription }) => {
        ...
        <div className="">
          ...
          <div className="cols">
            ...
            <div className="lg:w-[650px] lg:h-auto w-full " onTouchStart={handleTouchStart}>
              <div className="container mx-auto ">
                <div className="shadow-[4.0px_8.0px_8.0px_rgba(0,0,0,0.38)] front mb-8 " style={{ backgroundImage: `url(${image})` }}>
                  <div className="inner">
                  <h1 className='text-[white] text-3xl font-black'>{CardTitle}</h1>
                  <p className='text-8px mt-4 text-gray-300'>click image to see more</p>
                ...
                <div className="back shadow-[4.0px_8.0px_8.0px_rgba(0,0,0,0.38)]">
                  <div className="inner">
                    <p className='text-10px text-neutral-500'>{CardDescription}</p>
                  </div>
                </div>
              </div>
            </div>
